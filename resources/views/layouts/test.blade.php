...
<html lang="en" data-bs-theme="dark">
    <head>
        ...
        />
        <link rel="stylesheet" href="{{ asset("css/app-dark.rtl.css") }}" />
    </head>
                ...
                <div class="sidebar-wrapper active">
                    <div class="sidebar-header position-relative">
                        ...
                        >
                            ...
                            <div
                                class="theme-toggle d-flex align-items-center mt-2 gap-2"
                            >
                                <svg
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table
                                                    class="table-hover table-lg table"
                                                >
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content pb-4">
                                    ...
                                    <div class="px-4">
                                        <button
                                            class="btn btn-block btn-xl btn-outline-primary mt-3 font-bold"
                                        >
                                            Start Conversation
                                        </button>
                                    </div>
